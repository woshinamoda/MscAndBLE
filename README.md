...
现存问题2:传感器计算公式不一样？？？ max44009损坏，暂时无法测试<br>
现存问题3：需要修改硬件，充电的CE引脚拉出来，然后充电过程中，中断充电，并检查充电电量<br>
~~现存需要优化1: 通道的电源在不读的时候也需要切掉（功耗优化）<br>~~
~~寻村需要优化2: 清除文件后，csv0村子 1和2不见了， rtt会显示open error<br>~~

---
### update 2025-12-19
基本温湿度程序上遗留有问题的地方都解决了，具体参考下图<br>
![修改测试版](picture/解决程序问题.jpg)
*	解决usb和qpspi共同占用fatfs问题，延时解决
*	增加发送内部存储数据，添加蓝牙冲发送功能，但是不会卡住系统程序运行
* 提前预备好充电检测电量程序
* 完善收发逻辑/完善存入文件系统格式于各个通道固定长度
> 现在就剩余整理测试和使用文档，测试包含硬件电量测试。<br>
